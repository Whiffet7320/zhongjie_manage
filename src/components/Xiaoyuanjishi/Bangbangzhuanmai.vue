    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          ...
          <vxe-table-column field="product_name" title="转卖品"></vxe-table-column>
        ...
        <el-pagination
          ...
          :current-page="this.jishizhuanmaiPage"
          :page-size="10"
...
export default {
  computed: {
    ...mapState([
      "jishizhuanmaiPage",
      "jishizhuanmaiPageSize",
      "biaobaiqiangPinglunPage",
      "biaobaiqiangPinglunPageSize"
    ])
  },
  watch: {
    jishizhuanmaiPage: function(page) {
      this.$store.commit("jishizhuanmaiPage", page);
      this.getData();
    },
    jishizhuanmaiPageSize: function(pageSize) {
      this.$store.commit("jishizhuanmaiPageSize", pageSize);
      this.getData();
    },
  ...
  methods: {
    ...
    handleSizeChange(val) {
      ...
      this.$store.commit("jishizhuanmaiPageSize", val);
    },
    handleCurrentChange(val) {
      console.log(`当前页: ${val}`);
      this.$store.commit("jishizhuanmaiPage", val);
    }
  }
};
</script>
