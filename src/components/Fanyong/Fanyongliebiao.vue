    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          ...
          <vxe-table-column field="orderinfo.nickname" title="昵称"></vxe-table-column>
          <vxe-table-column field="orderinfo.avatar" title="头像">
            <template slot-scope="scope">
              <el-image
                :src="scope.row.orderinfo.avatar"
                :preview-src-list="[scope.row.orderinfo.avatar]"
                fit="fill"
          ...
          <vxe-table-column field="title" title="标题(中)"></vxe-table-column>
          <vxe-table-column field="english_title" title="标题(英)"></vxe-table-column>
          <vxe-table-column field="orderinfo.title" title="订单标题"></vxe-table-column>
          <vxe-table-column field="orderinfo.price" title="订单金额"></vxe-table-column>
          <vxe-table-column field="balance" title="获得前余额"></vxe-table-column>
          <vxe-table-column field="number" title="金额"></vxe-table-column>
          <vxe-table-column field="mark" title="备注(中)"></vxe-table-column>
          <vxe-table-column field="english_mark" title="备注(英)"></vxe-table-column>
...
export default {
  ...
  methods: {
    async getData() {
      const res = await this.$api.wallet_log({
