<template>
  <div class="index">
    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
            ...
            <template #content="{ row }">
              <template>
                <div class="xiala">
                  <el-row :gutter="20">
                    <el-col :span="18">
                      <div class="item">表白内容：{{row.content}}</div>
                    </el-col>
                  </el-row>
          ...
          <vxe-table-column field="mySender_name" title="告白者"></vxe-table-column>
          <vxe-table-column field="avatar_url" title="告白者头像">
        ...
        <el-pagination
          ...
          :current-page="this.biaobaiqiangPage"
          :page-size="10"
    ...
    >
      ...
      <div class="myTable">
        <vxe-table :data="pinlunList">
          <vxe-table-column field="id" width="80" title="ID"></vxe-table-column>
          <vxe-table-column field="myNickname" title="评论者"></vxe-table-column>
